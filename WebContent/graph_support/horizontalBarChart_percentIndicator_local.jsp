...
function localHorizontalBarChart(data, percent_var, domName, barLabelWidth) {
	...
	function draw() {
		...
		var x = d3.scaleLinear()
			.domain([0, d3.max(data, function(d){ return d.percent_var; })])
		...
		var barsContainer = g.append('g')
			...
			.attr('width', function(d) { return x(d.percent_var); })
			.attr('stroke', 'white')
			.attr('fill', '#006478');

...
function ${param.block}_age_refresh() {
	...
	localHorizontalGroupedStackedBarChart(${param.block}_AgeGenderArray,"${param.block}_age_viz", "observation", "age", "patient_count", "gender", "Gender", gender_legend, gender_range_no_other, "Observation", "Age");	
}

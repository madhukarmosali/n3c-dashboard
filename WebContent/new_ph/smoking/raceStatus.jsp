...
function ${param.block}_race_refresh() {
	console.log("reached");
   	d3.select("#${param.block}_severity_viz").select("svg").remove(); console.log(${param.block}_RaceStatusArray)
	localHorizontalStackedBarChart(${param.block}_RaceStatusArray,"${param.block}_race_viz", 120, status_legend, categorical, "Status");	
}

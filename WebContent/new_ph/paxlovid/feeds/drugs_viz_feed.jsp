...
<sql:query var="severity" dataSource="jdbc/N3CPublic">
        select jsonb_pretty(jsonb_agg(done order by condition,result_seq))
        from (select condition, result_abbrev as result, patient_display, patient_count, age_seq, result_seq
                        from (select

<div class="secondary-description">
	<p>Sample: <span class="tip">
				...
				</span>&nbsp;in the N3C Data Enclave over the age of 18. Data is aggregated by Age, Race, Gender, Severity, and individual comorbidities. Comorbidities for each patient are 

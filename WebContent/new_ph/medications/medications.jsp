...
<%-- 	<jsp:include page="../../graph_support/grouped_stacked_bar_horizontal_alexis.jsp"> --%>
...
function ${param.block}_medication_refresh() {
	...
	localHorizontalGroupedStackedBarChart(${param.block}_MedicationArray,"${param.block}_medication_viz", "drug_domain", "concept_set_name", "patient_count", 'age', "Age");	
}

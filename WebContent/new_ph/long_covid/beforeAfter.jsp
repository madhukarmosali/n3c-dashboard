...
function ${param.block}_before_refresh() {
	...
	localHorizontalStackedBarChart(${param.block}_BeforeAfterArray,"${param.block}_before_after_viz", 160, before_after_legend, categorical, "Symptom Occurrence", 200, 1);	
}

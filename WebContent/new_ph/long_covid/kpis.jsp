...
<c:choose>
	<c:when test="${param.block == 'long_covid_1'}">
		...
		<jsp:include page="../kpis/long_icd.jsp">
			<jsp:param name="block" value="${param.block}" />
		</jsp:include>
	</c:when>
	...
	<c:when test="${param.block == 'long_covid_3'}">
		...
		<jsp:include page="../kpis/long_icd_summary.jsp">
			<jsp:param name="block" value="${param.block}" />
		</jsp:include>
		<jsp:include page="../kpis/long_tested_positive.jsp">
			<jsp:param name="block" value="${param.block}" />
		</jsp:include>
		<jsp:include page="../kpis/long_in_record.jsp">
			<jsp:param name="block" value="${param.block}" />
		</jsp:include>
	</c:when>

...
<jsp:include page="../block2.jsp">
	...
	<jsp:param name="topic_description" value="Sample: All patients in the N3C Data Enclave with a recorded diagnosis of Shortness of Breath (R06.02, R06.00, or R06.09) since the start of data collection (1/1/2020). This diagnosis is non-specific to PASC and could be related to other illness." />

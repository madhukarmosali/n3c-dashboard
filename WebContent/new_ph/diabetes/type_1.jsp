...
function ${param.block}_refresh() {
	...
	localHorizontalGroupedStackedBarChart(${param.block}_GenderAgeArray,"${param.block}_diabetes_t1_viz", "observation", "gender", "patient_count", "age", "Age", age_legend_4, age_range, "Observation", "Gender");	
}

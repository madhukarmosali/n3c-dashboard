	...
	<div id="paxlovid_2">
		<div class="row">
			...
			<div class="col-12 col-md-6 viz-table" id="drugs_table_1">
				<h4>Top 20 Most Frequent Drugs Seen Between 6 to 29 Days After Paxlovid Treatment</h4>
				<jsp:include page="tables/top10_drugs_table.jsp" flush="true"/>
			</div>
		</div>
		<div class="row">
			<div class="col-12 col-md-6 viz-table" id="drugs_table_2">
				<h4>Drugs Seen Between 6 to 29 Days After Paxlovid Treatment (Total Occurrences Greater Than 20)</h4>
				<jsp:include page="tables/greater_drugs_table.jsp" flush="true"/>
			</div>
			<div class="col-12 col-md-6 viz-table" id="drugs_table_3">
				<h4>Drugs Seen Between 6 to 29 Days After Paxlovid Treatment (Total Occurrences Less Than 20)</h4>

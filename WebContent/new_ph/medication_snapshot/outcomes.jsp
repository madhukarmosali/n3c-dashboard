...
<div class="row">
	<div class="col-6 mx-auto mt-2 mb-2 text-center">
		<img alt="" src="<util:applicationRoot/>/new_ph/medication_snapshot/images/image1.png" style="height: 1000px;">
		<br><b>Figure 1. Cumulative % of patients who have a care visit after a 5 day
	...
	<div class="col-6 mx-auto mt-2 mb-2 text-center">
		<img alt="" src="<util:applicationRoot/>/new_ph/medication_snapshot/images/image2.png" style="height: 1000px;">
		<br><b>Figure 2. Heatmap showing new or continuing diagnoses in the
		...
		clinical testing and/or evaluation).
	</div>

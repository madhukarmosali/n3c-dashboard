...
<jsp:include page="../block2.jsp">
	...
	<jsp:param name="simple_panel" value="medication_snapshot/age.jsp" />

	<jsp:param name="datatable" value="medication_snapshot/demographics_age_table.jsp" />
	<jsp:param name="datatable_div" value="medication_snapshot_paxlovid_age" />

<div class="secondary-description">
	<p>Sample: <span class="tip">
				...
				within the Enclave. Data aggregated by the number of Charlson Comorbidities and Severity. Medications were aggregated based on ingredient included in the medication.</p>
</div>
